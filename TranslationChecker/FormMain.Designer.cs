namespace TranslationChecker
{
  partial class FormMain
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.labelSolutionPath = new System.Windows.Forms.Label();
      ...
      // labelSolutionPath
      // 
      this.labelSolutionPath.AutoSize = true;
      ...
      this.Controls.Add(this.labelSolutionPath);
      this.Controls.Add(this.textBoxSolutionPath);
      this.Controls.Add(this.buttonPickSolutionPath);
      this.Controls.Add(this.menuStrip1);
      this.MainMenuStrip = this.menuStrip1;
      this.Margin = new System.Windows.Forms.Padding(3, 2, 3, 2);
      this.Name = "FormMain";
      this.ShowIcon = false;
      this.Text = "Translation Checker";
    ...
    private System.Windows.Forms.Label labelSolutionPath;
